#/*******************************************************************************************/
# /* @fileoverview ReplitWEB is a script to run a web with interface in Replit!
# /* -----------------------------------------------------------------------------------------
# /* @version                               1.0.0
# /* -----------------------------------------------------------------------------------------
# /* @author                 HiroBeet <hirobeet@protonmail.com>
# /* @copyright                      GoldenCoers
# /* -----------------------------------------------------------------------------------------
# /* ReplitWEB has been fully developed by me.
#/*******************************************************************************************/
